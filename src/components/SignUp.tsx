...
export const SignUp = ({ onToggleMode }: SignUpProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (authError) {
      ...
      setSuccess(true);
      showToast('success', 'Account created. Check your inbox if verification is required.');
    }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-gray-900/50 backdrop-blur-xl border border-cyan-500/30 rounded-lg p-8 shadow-2xl shadow-cyan-500/20">
          ...
          {success && (
            <div className="mb-4 p-3 bg-green-500/10 border border-green-500/50 rounded-lg flex items-center text-green-400">
        ...
        <div className="mt-4 text-center text-gray-600 text-xs">
          <p>Secure Registration • Military-Grade Encryption</p>
        </div>
      </div>
    </div>
  );
